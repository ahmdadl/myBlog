    ...
    <ul class="list-unstyled mt-3">
        ...
        <li class="media {{ $loop->last ?: 'mb-4' }}">
            <img src="{{asset('img/user.png')}}"
                class="mr-3 rounded border border-primary"
            ...
            <div class="media-body">
                <h5 class="mt-0 mb-1 text-primary">
                    ...
                    <form action="{{$comment->path()}}" method='POST'
                        ...
                        @csrf
                        <button type="submit"
                            class="btn btn-sm btn-outline-danger"><strong>&times;</strong></button>
                    </form>
                    @endif
                </h5>
                {{$comment->body}}
                <button type="button"
                    class="btn btn-outline-primary ml-3 showReplayForm"
                    replay-id='replay{{$comment->id}}'>Replay</button>
